...
<script type="text/javascript">
	...
	<div class="login-top">
		<div class="wrapper">
			<div class="fl font30">卖家、管理员登录</div>
		...
		<div class="loginbox fl">
			<div class="tab" style="text-align: center;">
				<ul>
					...
					<a href="${path_}/admin/adminInUserLogin.jsp"><li class="on" style="color: red;">卖家、管理员登录</li></a>
				</ul>
			</div>
			<div class="conlist">
				...
				<div class="conbox" style="display: block;">
	            	...
	            	<form action="${path_}/adminLoginSubmit.action" onsubmit="return AdminSub();">
						...
						<p>
							<input type="submit" class="loginbtn" value="卖家登录、管理员登陆">
						</p>
					</form>
            	</div>
			</div>
